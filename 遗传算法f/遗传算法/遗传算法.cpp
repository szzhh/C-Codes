...
using namespace std;
//相关参数：
float Pov[4]={0.2,0.2,0.2,0.2};//变异的概率,其值分别为：增加树的层数，减少树的层数，数字变异，符号变异，P0与P1互斥，其余的变异均不冲突 
int layer;//最大层数
int prine_number=100;//初始种族数目
float max_c_p=1.0e+4;//最大环境适应度
int max_generation=40;//最大演化代数
int die_generation=5;//每隔多少代淘汰一次
float die_rate=0.5;//每次淘汰的比例
float in_percent;//境外个体百分比
int num_pre_generation=20;//每代产生的新个体个数
